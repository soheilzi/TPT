...
EVAL_OUTPUT_DIR="samples/math_eval_focal/2b"
NUM_SAMPLES_EVAL="5"
...
TRAIN_OUTPUT="data/next_ce/train2k.json" # we want to use the same train set for focal
EVAL_OUTPUT="data/next_ce/evnext.json" # we want to use the same eval set for focal
TRAIN_SIZE="2000"
